/* SCCSID @(#)floatlib.c	1.1 11/22/05 */
...
* 
**************************************************************************
*  FIXME: -a has to be: (float)0.0-a, or __negsf2(a)
**************************************************************************
*/
...
{
    return __cmpdf2((double)a1, (double)a2);
}
...
unsigned long
__fixunssfsi (float a1)
{
  double foo = a1;
  return __fixunsdfsi (foo);
}
...
int
__gtsf2 (float a1, float a2)
{
    return __cmpsf2 (a1, a2) > 0;
}

int
__gesf2 (float a1, float a2)
{
    return (__cmpsf2 (a1, a2) >= 0) - 1;
}

int
__ltsf2 (float a1, float a2)
{
    return - (__cmpsf2 (a1, a2) < 0);
}

int
__lesf2 (float a1, float a2)
{
    return __cmpsf2 (a1, a2) > 0;
}

int
__eqsf2 (float a1, float a2)
{
    //FIXME: that is a HACK for ESS gcc, it does NOT make sense, but it works!!!
    //return *(long *) &a1 == *(long *) &a2;
    return *(long *) &a1 != *(long *) &a2;
}

int
__nesf2 (float a1, float a2)
{
    return *(long *) &a1 != *(long *) &a2;
}
double
__muldi3(double a, double b)
{   
   return __mulsf3 ((float)a, (float)b);
   
}
int
__ashrdi3(double a,double b)
{
   return 0;
}

int
__ashldi3(double a,double b)
{
   return 0;
}

int
__lshrdi3(double a,double b)
{
   return 0;
}
